        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6 mb-8">
          ...
          <Link to="/admin/coupons">
            <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600">Quản lý Coupon</p>
                  <p className="text-lg font-bold text-teal-600">Mã giảm giá</p>
                </div>
          ...
          <Link to="/admin/media">
            <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600">Media Manager</p>
                  <p className="text-lg font-bold text-gray-900">Cloudinary</p>
                </div>
          ...
          <Link to="/admin/announcements">
            <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600">Thông báo hệ thống</p>
                  <p className="text-lg font-bold text-orange-600">Announcements</p>
                </div>
