...
const AuthFlip = ({ initialMode = 'login' }: Props) => {
  ...
  // NOTE: This page used to implement a 3D flip animation between login/register.
  // To avoid transform/layout issues, we keep login/register as separate routes
  // and render only one form per page.
