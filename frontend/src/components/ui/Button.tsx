interface ButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  ...
  variant?: 'primary' | 'secondary' | 'outline' | 'ghost' | 'danger' | 'inverted' | 'outline-inverted';
  size?: 'sm' | 'md' | 'lg';
  className?: string;
  loading?: boolean;
}
...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variantClasses = {
    ...
    inverted: 'bg-white text-blue-600 hover:bg-blue-50 focus:ring-blue-500 rounded-lg shadow-lg font-semibold',
    'outline-inverted': 'border-2 border-white text-white bg-transparent hover:bg-white hover:text-blue-600 focus:ring-white rounded-lg font-semibold'
  };
